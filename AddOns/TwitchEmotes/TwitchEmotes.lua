Emoticons_Settings={
  ...
  local dropdown_options={
	...
	[23]=  {"Pepe 4","PepePoo","FeelsComradeMan","PeepLaff","PeepGiggle","PeepKek","monakHmm","FeelsOakyMan","FeelsWiredMan","PeepHand","monakS","PepeHmm","FeelsBoredMan","PepeCry","PepeJAM","FeelsFatMan","FUARK","PepeLove","PepeHeart","PepeCoolStory","PepeMeltdown","PepePants","PepeM","ppFootbol","PepeAyy","PepeRun","PepeLegs","PepeReach","noClown","LULERS","PepeDisgust","SmugPepe","OMEGAEZ","PepePains"},
	...
	[28]=  {"Axt Custom P1","PogClappa","cmoN","OhISee","Poghurt","espanLOL","kekW","pOg","PogU","PogYou","Pogey","KKool","KKonaW","kkOna","DKKona","KKonductor","TriKool","TriSoft","5Hard","TriHeart","TriAngle","TriEasy","TriGold",":bench:","1Head","2Head","3Head","3Lass","cmonBruv","4Weird","4House","4Mansion","5Head"},
	[29]=  {"Axt Custom P2","thinkioning","noxSorry","AMAZINGA","BaconEffect","PBear","BearDab","TriHardS","HYPERDANSGAME","HYPERDANSGAMEW","LULWW","WULL","MaN","NaM","VaN","WhiteKnight","BlackKnight","PikaWOW","Boomer","WeirdChamp","WutChamp","StareChamp","OkayChamp","MaldChamp","DisappointChamp","SadChamp","EZChamp","SillyChamp","LULChamp","CrazyChamp","WeirdBruh","ChagU","ANGERY","feelsblob"},
  };
